...
def get_model_complexity_info(
    ...
    if backend == 'pytorch':
        flops_count, params_count = get_flops_pytorch(
            model,
            input_res,
    ...
    if as_strings:
        flops_string = flops_to_string(flops_count, units=flops_units, precision=output_precision)
        params_string = params_to_string(params_count, units=param_units, precision=output_precision)
